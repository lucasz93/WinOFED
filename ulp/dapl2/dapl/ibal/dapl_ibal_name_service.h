...
char* dapli_IPaddr_str(
	IN    DAT_SOCK_ADDR *sa,
	IN    OPTIONAL char *buf );

DAT_RETURN dapli_IbatQueryPathRecordByIPaddr(
...
extern HRESULT __stdcall IbatQueryIPaddrByGid(
	IN const ib_gid_t         *pGid,
	OUT const SOCKADDR_INET   *pDestAddr );
