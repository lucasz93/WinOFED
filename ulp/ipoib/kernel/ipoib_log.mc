...
Facility=IPoIB
Severity=Error
SymbolicName=EVENT_IPOIB_START_UP_DEV_REG_ATTR
Language=English
%2: SetDeviceRegistrationAttributes failed.
.

MessageId=0x005F
Facility=IPoIB
Severity=Error
SymbolicName=EVENT_IPOIB_START_UP_ADAPTER_REG_ATTR
Language=English
%2: SetAdapterRegistrationAttributes failed.
.
...
Language=English
%2: SetOffloadAttributes failed.
.

MessageId=0x0061
Facility=IPoIB
Severity=Error
SymbolicName=EVENT_IPOIB_START_UP_CREATE_ADAPTER
Language=English
%2: ipoib_create_adapter failed.
.

MessageId=0x0062
Facility=IPoIB
Severity=Error
SymbolicName=EVENT_IPOIB_START_UP_START_ADAPTER
Language=English
%2: ipoib_start_adapter failed.
.

MessageId=0x0063
Facility=IPoIB
Severity=Informational
SymbolicName=EVENT_IPOIB_CM_LSO_DISABLED
Language=English
